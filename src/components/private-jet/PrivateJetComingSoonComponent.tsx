...
export const PrivateJetComingSoonComponent = () => {
  return (
    <main
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 20%, #f0d484 0%, transparent 45%), radial-gradient(circle at 80% 60%, #f0d484 0%, transparent 40%)",
        }}
        aria-hidden
      />
        ...
        >
          <div className="flex flex-col items-start text-left">
            ...
            <p
              ...
              style={{ color: "#7b879d" }}
            >
              You can contact us to discuss private jet charter for your route,
              dates, and cabin preferences.{" "}
