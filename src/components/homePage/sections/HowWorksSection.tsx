...
export const HowWorksSection = ({ data }: HowWorksSectionProps) => {
  ...
  const list = [
    {
      desc: data?.how_it_works_ideation_desc_en,
      icon: "/images/how-works/one.svg",
    },
    {
      desc: data?.how_it_works_co_creation_desc_en,
      icon: "/images/how-works/two.svg",
    },

    {
      desc: data?.how_it_works_funding_desc_en,
      icon: "/images/how-works/three.svg",
    },
    {
      desc: data?.how_it_works_scaling_desc_en,
      icon: "/images/how-works/four.svg",
    },
    {
      desc: data?.how_it_works_exits_desc_en,
          ...
          <div className="heading how-works-heading">
            ...
            <div
              dangerouslySetInnerHTML={{
                __html: data?.how_it_works_description_desc_en || "",
              }}
            />
