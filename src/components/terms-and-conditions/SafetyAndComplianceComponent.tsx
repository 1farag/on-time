...
const SLUG = "safety-and-compliance";

export const SafetyAndComplianceComponent = () => {
        ...
        <section className="bg-[#0B0E14] py-20 px-6">
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-third text-base">
              Safety and compliance content is currently unavailable.
            </p>
          </div>
        </section>
      </main>
      ...
      <section className="mt-14 py-20 px-6">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-third text-base">
              Please read our safety and compliance information carefully.
            </p>
          </div>
