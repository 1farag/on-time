...
type TableServerPaginationType<T extends Record<string, any>> = {
...
export const TableServerPagination = <T extends Record<string, any>>({
  columns,
  data,
  onSelectedChange,
  isLoading,
  ...
  const modifiedDataSource = (data || []).map((row, index) => ({
    ...row,
  ...
  const rowSelection: TableRowSelection<T> = {
    ...
    onChange: (newSelectedRowKeys: React.Key[], selectedRows) => {
      ...
      setSelectedRows(selectedRows as T[]);
      if (onSelectedChange) {
