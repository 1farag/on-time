...
export const RegisterCompanyForm = () => {
  const [form] = Form.useForm<RegisterCompanyPayload>();
  const { registerCompany, isRegistering } = useRegisterCompany();
  ...
  const handleFinish = async (values: RegisterCompanyPayload) => {
    const payload: RegisterCompanyPayload = {
      ...
      annualTravelVolume: Number(values.annualTravelVolume),
    ...
    try {
      ...
      // Errors are surfaced via toast in useRegisterCompany
    }
  };
        ...
        <div className="formS1 !border-none !p-0">
          <Row gutter={[30, 30]}>
              ...
              <div className="inputS1">
                <Form.Item
                  ...
                  rules={[
                    {
                      required: true,
                      message: "Enter commercial register number",
                    },
                  ]}
                >
                  <Input placeholder="Commercial register" />
                </Form.Item>
              </div>
            </Col>
            ...
            <Col xs={24} md={12}>
              <div className="inputS1">
                <Form.Item
                  label="Sector"
                  name="sector"
                  rules={[{ required: true, message: "Enter sector" }]}
                >
                  <Input placeholder="Sector / industry" />
                </Form.Item>
              </div>
            </Col>
            ...
            <Col xs={24} md={12}>
              <div className="inputS1">
                <Form.Item
                  ...
                  rules={[
                    { required: true, message: "Enter employees number" },
                  ]}
                >
                  <InputNumber
                    className="!w-full"
            ...
            <Col xs={24} md={12}>
              <div className="inputS1">
                <Form.Item
                  label="Annual Travel Volume"
                  name="annualTravelVolume"
                  rules={[
                    { required: true, message: "Enter annual travel volume" },
                  ]}
                >
                  <InputNumber
                    className="!w-full"
            ...
            <Col xs={24} md={12}>
              <div className="inputS1">
                <Form.Item
                  label="Communications Officer Name"
                  name="communicationsOfficerName"
                  rules={[
                    {
                      required: true,
                      message: "Enter communications officer name",
                    },
                  ]}
                >
