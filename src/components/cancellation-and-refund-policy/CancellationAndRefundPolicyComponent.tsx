...
const SLUG = "cancellation-and-refund-policy";

export const CancellationAndRefundPolicyComponent = () => {
        ...
        <section className="bg-[#0B0E14] py-20 px-6">
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-third text-base">
              Cancellation and refund policy content is currently unavailable.
            </p>
          </div>
        </section>
      </main>
