          ...
          <div className="content ps-[165px] lg:ps-6">
            <h1
              dangerouslySetInnerHTML={{
                __html:
                  "Insights from the <br /> Frontlines of Innovation",
              }}
            />
            <p>
              Stay ahead of the curve with expert perspectives, actionable advice, and the latest trends in entrepreneurship and venture building.
            </p>
